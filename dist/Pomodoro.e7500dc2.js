...
},{"react":"node_modules/react/index.js","./Pomodoro.js":"src/components/Pomodoro.js"}],"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/scss/style.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/components/Pomodoro.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Pomodoro(props) {
    ...
    _this.restartInterval = _this.restartInterval.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    ...
    _this.restart = _this.reset.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(Pomodoro, [{
    key: "play",
    value: function play() {
      var newState = this.state.timer - 1;
      this.setState({
        timer: newState,
        start: true,
        btnState: "Restart"
    ...
    key: "formatingTimer",
    value: function formatingTimer(sec) {
      var minutes = Math.floor(sec % 3660 / 60);
      var secondes = Math.floor(sec % 3600 % 60);
      var newTimer = minutes + ":" + (secondes < 10 ? "0" : "") + secondes;
      return newTimer;
    }
  }, {
    key: "increment",
    value: function increment() {
      if (this.state.timer < 3660) {
        var increment = this.state.timer + 60;
        this.setState({
          timer: increment
        });
      }
    ...
    value: function decrement() {
      if (this.state.timer > 0) {
        var decrement = this.state.timer - 60;
        this.setState({
          timer: decrement
        });
      }
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(_Header.default, null), _react.default.createElement("div", {
        ...
        className: "pomodoro_container"
      }, _react.default.createElement("h2", null, this.state.title), _react.default.createElement("div", {
        className: "timer_container"
      }, this.formatingTimer(this.state.timer)), _react.default.createElement("button", {
        className: "start-btn",
        onClick: this.restartInterval
      }, this.state.btnState), _react.default.createElement("button", {
        className: "stop-btn",
        onClick: this.restartInterval
...
_reactDom.default.render(_react.default.createElement(Pomodoro, null), App);
},{"react":"node_modules/react/index.js","react-dom":"node_modules/react-dom/index.js","./Header.js":"src/components/Header.js","../scss/style.css":"src/scss/style.css"}],"../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../usr/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/components/Pomodoro.js"], null)
//# sourceMappingURL=/Pomodoro.e7500dc2.map